...
for (const vault of vaults) {
	...
	const dest = join(vault, ".obsidian", "plugins", "powereditor");
...
console.log(deployed ? `Done. Reload Obsidian (Ctrl+R) and enable "Power Editor" if it isn't enabled yet.` : "Nothing deployed.");
